 ...
 */
final class Version20210721141600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, short_description VARCHAR(450) NOT NULL, long_description VARCHAR(4500) NOT NULL, title VARCHAR(100) NOT NULL, image VARCHAR(250) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE devis (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, type_de_bien VARCHAR(450) NOT NULL, budget DOUBLE PRECISION NOT NULL, surface INT NOT NULL, description VARCHAR(4500) NOT NULL, mail VARCHAR(255) NOT NULL, telephone INT NOT NULL, INDEX IDX_8B27C52B12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tuto (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, image VARCHAR(100) NOT NULL, title VARCHAR(100) NOT NULL, short_description VARCHAR(450) NOT NULL, long_description VARCHAR(4500) NOT NULL, INDEX IDX_17D825712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
